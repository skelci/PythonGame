...
class Game(GameBase):
    def begin_play(self):
        ...
        reg(Rigidbody("Rigidbody1", Vector(0.5, 0.5), Vector( 2 ,  2), True, "res/textures/texture.jpeg", 0.9, Vector(6, 7), 0, 8 , 1, 0, 0.01))
        reg(Rigidbody("Rigidbody2", Vector(0.5, 0.5), Vector( 2 , -2), True, "res/textures/texture.jpeg", 0.9, Vector(7, 6), 0, 4 , 1, 0, 0.01))
        reg(Rigidbody("Rigidbody3", Vector(0.5, 0.5), Vector(-3 ,  2), True, "res/textures/texture.jpeg", 0.9, Vector(4, 9), 0, 1 , 1, 0, 0.01))
        reg(Rigidbody("Rigidbody4", Vector(0.5, 0.5), Vector(-3 , -2), True, "res/textures/texture.jpeg", 0.9, Vector(9, 4), 0, 96, 1, 0, 0.01))
